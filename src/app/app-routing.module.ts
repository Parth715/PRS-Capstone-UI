...
const routes: Routes = [
  ...
  {path: "requestlines/:id", component: RequestlineComponent},
  {path: "requestlinesedit/:id/:requestid", component: RequestlinesEditComponent},
  {path: "requestlinescreate/:id", component: RequestlinesCreateComponent},
